...
def main():
    ...
    R_sample = train(X_missing_data, missing_ID, X_notmissing_data, samplesize, weight, index1, index2, iter+1,  D_1, D_2, D_3, du1, du2, lambdad, lambdar, lambdax, lambdau, lambdav, maxiter, step, pretrainstep)
